      ...
      <div className={ [styles['footer__inner'], 'container'].join(' ') }>
        <ul className={ styles['footer__list-document'] }>
          ...
          <li className={ styles['footer__item'] }>
            <a className={ styles['footer__link'] }
              data-tag-manager='click-link'
              href='/documents/agreement-owners'
              target='_blank'
            >
              Образец договора
            </a>
        ...
        <ul className={ styles['footer__list-socials'] }>
          <li className={ styles['footer__item-socials'] }>
            <a className={ styles['footer__img-socials'] }
              data-tag-manager='click-contacts-instagram'
              href='https://instagram.com/rento.one?utm_medium=copy_link'
          ...
          <li className={ styles['footer__item-socials'] }>
            <a className={ styles['footer__img-socials'] }
              data-tag-manager='click-contacts-telegram'
              href='https://t.me/rento_one'
              rel='noopener noreferrer'
              target='_blank'
              title='Telegram'
            >
          ...
          <li className={ styles['footer__item-socials'] }>
            <a className={ styles['footer__img-socials'] }
              data-tag-manager='click-contacts-whatsapp'
              href='https://wa.me/message/QS2O2VHMJW7IN1'
              rel='noopener noreferrer'
              target='_blank'
              title='Whatsapp'
            >
          ...
          <li className={ styles['footer__item-socials'] }>
            <a className={ styles['footer__img-socials'] }
              data-tag-manager='click-contacts-facebook'
              href='https://facebook.com/rento.one'
              rel='noopener noreferrer'
              target='_blank'
              title='Facebook'
            >
        ...
        <ul className={ styles['footer__list-contact'] }>
          <li className={ styles['footer__item'] }>
            <a className={ styles['footer__link'] }
              data-tag-manager='click-contacts-phone'
