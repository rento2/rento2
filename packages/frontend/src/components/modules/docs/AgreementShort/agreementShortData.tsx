import { IListProps } from '@elements/lists/DocsList/types/IListProps'
    ...
    contents: [
      {
        ...
        contents: [
          ...
          {
            type: 'list',
            class: 'document__list-2',
            contents: [
              {
                type: 'item',
                class: 'document__item-2',
                contents: [
                  {
                    type: 'description',
                  ...
                  {
                    type: 'list',
                    class: 'document__list-3',
                    contents: [
                      {
                        type: 'item',
                        class: 'document__item-3',
