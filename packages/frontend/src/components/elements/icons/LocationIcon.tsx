export default function LocationIcon (): JSX.Element {
  return (
    ...
    >
      <path
        d="M12.4999 13.4304C14.223 13.4304 15.6199 12.0336 15.6199 10.3104C15.6199 8.5873 14.223 7.19043 12.4999 7.19043C10.7768 7.19043 9.37988 8.5873 9.37988 10.3104C9.37988 12.0336 10.7768 13.4304 12.4999 13.4304Z"
        stroke="#2D2F39"
      />
      <path
