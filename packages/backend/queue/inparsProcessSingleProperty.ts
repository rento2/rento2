...
export default async (process: Process): Promise<Process> => {
  ...
  apartment.geoCoordinateX = property.lat
  apartment.geoCoordinateY = property.lng
  apartment.subwayStation = String(property.metroId)
  apartment.subwayLine = null
  apartment.timeToSubwayByFoot = 0
  apartment.timeToSubwayByVehicle = 0
  apartment.repairs = 0
  apartment.purity = 0
